...
// Serves uploaded product images. Public on purpose: the same images appear on
// the public purchase-link pages. File names are random UUIDs and validated
// against a strict pattern, so this cannot be used to read other files.
